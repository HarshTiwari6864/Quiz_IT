   ...
   render() {
       return (
           <div className="create-quiz-wrapper">
               ...
               <div className="main">
                   <div className="header">Create Quiz</div><hr/>
                   <div className="form card">
                       ...
                       <br></br>
                       <select value={this.state.categoryVal} onChange={e => this.setState({categoryVal: e.target.value})} className="input select box" placeholder="Category">
