    ...
    render() {
        ...
        return (
            <div className="auth-wrapper">
                ...
                <div className="left">
                    <img src="https://freesvg.org/img/puzzlemind.png" />
                </div>

                <div className="right">
                    <div className="header">Quizzers</div>
                    <div className="sub-header">Quiz platform for better learning</div>
                    {page}
                    <div className="new" onClick={this.changeTab}>{this.state.tab === 'signin' ? 'New Quizer? Sign up here' : 'Old Champion? Sign in'}</div>
                </div>
            </div>
        )
    }
